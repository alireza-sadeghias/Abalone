    ...
    public static void Selection(){
        for(int i=1; i<=initialGenerationSize; i++) {
            for(int j=1; j<4; j++){
                ...
                double[][] player1 =   ReadMatrix.ReadIn(System.getProperty("user.dir") + ReadMatrix.Slash + "ir/alireza/sadeghi/shiraz/AI" +ReadMatrix.Slash+"Trainers"+ReadMatrix.Slash+ "AInumber" + ReadMatrix.gen +"_" +j + ".txt");
                double[][] player2 =   ReadMatrix.ReadIn(System.getProperty("user.dir") + ReadMatrix.Slash + "ir/alireza/sadeghi/shiraz/AI" +ReadMatrix.Slash+"Matrices"+ReadMatrix.Slash+ "AInumber" + ReadMatrix.gen +"_" +i + ".txt");
                int Trainer=-1;
                ...
                for(int k=0; k<amountGames; k++){
                    ...
                    ReadResult.AddResult(System.getProperty("user.dir") + ReadMatrix.Slash + "ir/alireza/sadeghi/shiraz/AI" +ReadMatrix.Slash+"Results"+ReadMatrix.Slash+ "AIResult" + ReadMatrix.gen +"_" +i +"_" +j+ ".txt",result);
                }
            }
        }
    }
