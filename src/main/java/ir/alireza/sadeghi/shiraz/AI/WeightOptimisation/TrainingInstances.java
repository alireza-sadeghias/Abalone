...
public class TrainingInstances {
    ...
    static double[][] AggressiveInstance = ReadMatrix.ReadIn(System.getProperty("user.dir") + ReadMatrix.Slash+ "ir/alireza/sadeghi/shiraz/AI" +ReadMatrix.Slash+"StartingAI"+ReadMatrix.Slash + "Aggressive" + ".txt");
    static double[][] NeutralInstance = ReadMatrix.ReadIn(System.getProperty("user.dir") +  ReadMatrix.Slash+ "ir/alireza/sadeghi/shiraz/AI" +ReadMatrix.Slash+"StartingAI"+ReadMatrix.Slash + "Neutral" + ".txt");
    static double[][] DefensiveInstance = ReadMatrix.ReadIn(System.getProperty("user.dir") +  ReadMatrix.Slash+ "ir/alireza/sadeghi/shiraz/AI" +ReadMatrix.Slash+"StartingAI"+ReadMatrix.Slash + "Defensive" + ".txt");
