...
public class ReadResult {
    ...
    public static void ReadOut(){
        FileNumber++;
        for(int i=1; i<4; i++) {
            File doc = new File(System.getProperty("user.dir") + ReadMatrix.Slash + "ir/alireza/sadeghi/shiraz/AI" + ReadMatrix.Slash + "Results" + ReadMatrix.Slash + "AIResult" + ReadMatrix.gen + "_" + FileNumber + "_" + i + ".txt");
